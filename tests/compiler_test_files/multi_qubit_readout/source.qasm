...
defcal measure $0 -> bit {
    delay[16ns] flux_bias;
    play(tx_frame_0, ones(16ns)*0.3);
    return capture_v2(rx_frame_0, ones(16ns)*0.9);
}

defcal measure $1 -> bit {
    delay[32ns] xy_frame_1;
    play(tx_frame_1, ones(32ns)*0.2);
    return capture_v2(rx_frame_1, ones(32ns)*1);
}
