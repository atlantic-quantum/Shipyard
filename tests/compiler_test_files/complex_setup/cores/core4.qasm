...
cal {
  port adc0;
  port dac3;
  frame tx_frame_0 = newframe(dac3, 5700000000.0, 0.0);
  frame rx_frame_0 = newframe(adc0, 5700000000.0, 0.0);
  frame tx_frame_1 = newframe(dac3, 5800000000.0, 0.0);
  frame rx_frame_1 = newframe(adc0, 5800000000.0, 0.0);
  frame tx_frame_2 = newframe(dac3, 5900000000.0, 0.0);
  frame rx_frame_2 = newframe(adc0, 5900000000.0, 0.0);
}
cal {
